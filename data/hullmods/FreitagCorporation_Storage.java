...
public class FreitagCorporation_Storage extends BaseHullMod {
    ...
    private static final float STORAGE_ADDITIONAL_BERTHING = 1100f;
    private static final float STORAGE_AUXILIARY_FUEL_TANKS = 1100f;
    private static final float STORAGE_EXPANDED_CARGO_HOLDS = 700;
